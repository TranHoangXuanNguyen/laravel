	...
	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="source/image/slide/banner1.jpg" width="200px" alt=""></a>
				</div>
				<div class="pull-right beta-components space-left ov">
					<div class="space10">&nbsp;</div>
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="/public">
					...
					<div class="beta-comp">
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="source/image/slide/banner1.jpg" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Sample Woman Top</span>
											<span class="cart-item-options">Size: XS; Colar: Navy</span>
											<span clss="cart-item-amount">1*<span>$49.50</span></span>
										</div>
									</div>
								</div>
								...
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="source/image/slide/banner1.jpg.png" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Sample Woman Top</span>
											<span class="cart-item-options">Size: XS; Colar: Navy</span>
							...
							<div class="row">
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.blade.php"><img src="source/assets/dest/images/products/1.jpg" alt=""></a>
										</div>
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.blade.php"><i class="fa fa-shopping-cart"></i></a>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="product.blade.php"><img src="source/image/slide/banner1.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
	...
	<div class="copyright">
		<div class="container">
			...
			<p class="pull-right pay-options">
				<a href="#"><img src="source/image/slide/banner1.jpg" alt="" /></a>
				<a href="#"><img src="source/image/slide/banner1.jpg" alt="" /></a>
				<a href="#"><img src="source/image/slide/banner1.jpg" alt="" /></a>
				<a href="#"><img src="source/image/slide/banner1.jpg" alt="" /></a>
			</p>
