	...
	<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="index.blade.php"><i class="fa fa-home"></i> Home</a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.blade.php" id="logo"><img src="../../../public/source/assets/dest/images/logo-cake.png" width="200px" alt=""></a>
				</div>
					...
					<ul class="l-inline ov">
						<li><a href="index.blade.php">Home</a>
							<ul class="sub-menu">
								...
								<li><a href="index.blade.php">Home Shop 1</a></li>
						...
						<li><a href="index.blade.php">Shop</a>
							<ul class="sub-menu">
								<li><a href="index.blade.php">Home Shop 1</a></li>
								<li><a href="home_2.html">Home Shop 2</a></li>
								<li><a href="home_3.html">Home Shop 3</a></li>
		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="index.blade.php">Home</a> / <span>Shopping Cart</span>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
					...
					<tbody>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="../../../public/source/assets/dest/images/shoping1.jpg" alt="">
									<div class="media-body">
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="../../../public/source/assets/dest/images/shoping2.jpg" alt="">
									<div class="media-body">
										<p class="font-large table-title">Men’s Belt</p>
										<p class="table-option">Color: Red</p>
										<p class="table-option">Size: M</p>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="../../../public/source/assets/dest/images/shoping3.jpg" alt="">
									<div class="media-body">
										<p class="font-large table-title">Men’s Belt</p>
										<p class="table-option">Color: Red</p>
										<p class="table-option">Size: M</p>
